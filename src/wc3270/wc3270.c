 ...
 * c3270 will stop before the next wc3270> prompt is printed.
 */
static void
...
/*
 * SIGTSTP haandler for use while the wc3270> prompt is being displayed.
...
#if !defined(_WIN32) /*[*/
	/* Handle SIGTSTP differently at the wc3270> prompt. */
	signal(SIGTSTP, SIG_DFL);

	/*
	 * Ignore SIGINT at the wc3270> prompt.
