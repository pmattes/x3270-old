...
AllowNoIcons=yes
OutputBaseFilename=wc3270-3.3.9beta9-setup
...
[Icons]
Name: "{group}\wc3270 Session Wizard"; Filename: "{app}\wc3270wiz.exe"; WorkingDir: "{app}"
...
[Run]
Filename: "{app}\wc3270wiz.exe"; Description: "{cm:LaunchProgram,wc3270 Session Wizard}"; Flags: nowait postinstall skipifsilent
...
Filename: "{app}\mkshort.exe"; Parameters: """{app}"" wc3270wiz.exe ""wc3270 Session Wizard"""; Flags: nowait skipifsilent runhidden; Tasks: desktopicon

[UninstallRun]
Filename: "{cmd}"; Parameters: "/c erase ""{userdesktop}\wc3270.lnk"""; Tasks: desktopicon; Flags: runhidden; MinVersion: 0,4.0
Filename: "{cmd}"; Parameters: "/c erase ""{userdesktop}\wc3270 Session Wizard.lnk"""; Tasks: desktopicon; Flags: runhidden; MinVersion: 0,4.0
Filename: "{cmd}"; Parameters: "/c erase ""{userdesktop}\wc3270.pif"""; Tasks: desktopicon; Flags: runhidden; MinVersion: 4.0,0
Filename: "{cmd}"; Parameters: "/c erase ""{userdesktop}\wc3270 Session Wizard.pif"""; Tasks: desktopicon; Flags: runhidden; MinVersion: 4.0,0
