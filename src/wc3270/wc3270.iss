...
AllowNoIcons=yes
OutputBaseFilename=wc3270-3.3.9ga12-setup
OutputDir=.
Compression=lzma
...
Source: "w3n4.dll"; DestDir: "{app}"; Flags: ignoreversion; OnlyBelowVersion: 0.0,5.01
Source: "w3n46.dll"; DestDir: "{app}"; Flags: ignoreversion; MinVersion: 0.0,5.01
Source: "shf.dll"; DestDir: "{app}"; Flags: ignoreversion; MinVersion: 0.0,5.0
